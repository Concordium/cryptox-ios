...
class ContractAddressObject: Object {
    ...
    @objc dynamic var subindex: String = ""
...
protocol TransferDataType: DataStoreProtocol, TransactionType {
    ...
    var contractAddressObject: ContractAddressObject {get set}
}
...
final class TransferEntity: Object {
    ...
    @objc dynamic var contractAddress: ContractAddressObject?
}

extension TransferEntity: TransferDataType {
    var contractAddressObject: ContractAddressObject {
        get {
            let a = ContractAddressObject()
            a.index = "51"
            a.subindex = "0"
            return contractAddress ?? a
        }
        set {
            self.contractAddress = newValue
        }
    }
