...
public class TokenFormatter {
    ...
    ///   - shortFormat: if true, then uses short formatting, otherwise uses full formatting. Default is false.
    /// - Returns: Formatted number as a string.
    public func string(from number: BigDecimal,
                       decimalSeparator: String = Locale.autoupdatingCurrent.decimalSeparator ?? ".",
                       thousandSeparator: String = Locale.autoupdatingCurrent.groupingSeparator ?? ",",
    ...
    static func groups(string: String, size: Int) -> [String] {
