...
extension MobileWallet {
    func createTransferUpdate(from fromAccount: AccountDataType,
                              to toAccount: String,
    ...
    -> AnyPublisher<CreateTransferRequest, Error> {
        requestPasswordDelegate.requestUserPassword(keychain: keychain).tryMap { (pwHash: String) in
            try self.createTransferUpdate(fromAccount: fromAccount,
                                          toAccount: toAccount,
    ...
    private func createTransferUpdate(fromAccount: AccountDataType,
                                      toAccount: String,
                                      contractAddress: ContractAddress1,
                                      params: String,
                                      receiveName: String,
        ...
        let makeCreateTransferRequest: MakeUpdateTransferRequest = MakeUpdateTransferRequest(
